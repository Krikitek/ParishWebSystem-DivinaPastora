document.addEventListener("DOMContentLoaded", () => {
  ...
  const toPaymentBtn = document.getElemdocument.addEventListener("DOMContentLoaded", () => {
  // Get form sections
  const scheduleFormSection = document.getElementById("schedule-form-section")
  const step1ReviewSection = document.getElementById("step1-review-section")
  const acknowledgementSection = document.getElementById("acknowledgement-section")
  ...
  const serviceFields = {
    BAPTISM: `
      ...
      <!-- Additional baptism fields would continue here -->
    `,
    ...
    CONFIRMATION: `
      ...
      <!-- Additional confirmation fields would continue here -->
    `,
    ...
    COMMUNION: `
      ...
      <!-- Additional communion fields would continue here -->
    `,
    ...
    WEDDING: `
      ...
      <!-- Additional wedding fields would continue here -->
    `,
    ...
    FUNERAL: `
      ...
      <!-- Additional funeral fields would continue here -->
    `,
    ...
    INTENTION: `
      ...
      <div class="form-row">
          <div class="form-group">
              ...
              <div class="input-field">
                  <input type="date" id="preferredIntentionDate" name="preferredIntentionDate" required>
              </div>
          </div>
          <div class="form-group">
              <label>
              ...
              <div class="select-field">
                  <select id="preferredIntentionTime" name="preferredIntentionTime" required>
                      <option value="" disabled selected>PUMILI NG ORAS</option>
      ...
      <!-- Additional intention fields would continue here -->
    `,
  }
  ...
  function goToPayment() {
    if (acknowledgementTerms?.checked) {
      ...
      // Trigger flash animation for payment breakdown
      setTimeout(() => {
        const breakdown = document.getElementById("payment-breakdown")
        if (breakdown) {
          breakdown.classList.add("flash-animation")
        }
      }, 100)
    } else {
    ...
    if (selectedService === "BAPTISM") {
      ...
      html += `
        <div class="review-row">
          <div class="review-label">Pangalan ng Bibinyagan:</div>
      ...
      html += `
        <div class="review-row">
          <div class="review-label">Serbisyo:</div>
          <div class="review-value">Kumpil (Confirmation)</div>
        </div>
      `
    } else if (selectedService === "COMMUNION") {
      html += `
        <div class="review-row">
          <div class="review-label">Serbisyo:</div>
          <div class="review-value">Unang Komunyon (First Communion)</div>
        </div>
      `
    } else if (selectedService === "WEDDING") {
      html += `
        <div class="review-row">
          <div class="review-label">Serbisyo:</div>
          <div class="review-value">Kasal (Wedding)</div>
        </div>
      `
    } else if (selectedService === "FUNERAL") {
      html += `
        <div class="review-row">
          <div class="review-label">Serbisyo:</div>
          <div class="review-value">Libing (Funeral)</div>
        </div>
      `
    } else if (selectedService === "INTENTION") {
      html += `
        <div class="review-row">
          <div class="review-label">Serbisyo:</div>
          <div class="review-value">Intensyon sa Misa (Mass Intention)</div>
        </div>
      `
    }
  ...
  function saveToLocalStorage() {
    const data = {
      ...
      preferredBaptismDate: document.getElementById("preferredBaptismDate")?.value,
      preferredBaptismTime: document.getElementById("preferredBaptismTime")?.value,
      childLastName: document.getElementById("childLastName")?.value,
      childFirstName: document.getElementById("childFirstName")?.value,
      childMiddleName: document.getElementById("childMiddleName")?.value,
      preferredConfirmationDate: document.getElementById("preferredConfirmationDate")?.value,
      preferredConfirmationTime: document.getElementById("preferredConfirmationTime")?.value,
      preferredCommunionDate: document.getElementById("preferredCommunionDate")?.value,
      preferredCommunionTime: document.getElementById("preferredCommunionTime")?.value,
      preferredWeddingDate: document.getElementById("preferredWeddingDate")?.value,
      preferredWeddingTime: document.getElementById("preferredWeddingTime")?.value,
      preferredFuneralDate: document.getElementById("preferredFuneralDate")?.value,
      preferredFuneralTime: document.getElementById("preferredFuneralTime")?.value,
      preferredIntentionDate: document.getElementById("preferredIntentionDate")?.value,
      preferredIntentionTime: document.getElementById("preferredIntentionTime")?.value,
      gcashNumber: gcashNumber?.value,
    }

    localStorage.setItem("churchScheduleData", JSON.stringify(data))
  }
})
entById("to-payment-btn")
  const backToAcknowledgementBtn = document.getElementById("back-to-acknowledgement-btn")
  const payWithGcashBtn = document.getElementById("pay-with-gcash-btn")
  const verifyPaymentBtn = document.getElementById("verify-payment-btn")
  const cancelScheduleBtn = document.getElementById("cancel-schedule-btn")
